...
public class XmlParser{
    ...
    public static void checkValidity(Document file, String tag)
    {
        try {
            ...
            Writer output = new BufferedWriter(new FileWriter(tag + "Licenses.xml"));
            String xmlOutput = result.getWriter().toString();
            output.write(xmlOutput);
            output.close();
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            checkValidity(document1, "invalid");

            System.out.println("Checking for valid License");
            checkValidity(document2, "valid");
